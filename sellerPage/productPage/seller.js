...
async function postData(obj) {
    try {
      const response=await axios.post('https://crudcrud.com/api/effefa6daf8b4267921b918351ecf91c/userDeatils', obj)
...
async function deleteUser(user_id, price,option) {
    try {
     const del= await axios.delete(`https://crudcrud.com/api/effefa6daf8b4267921b918351ecf91c/userDeatils/${user_id}`)
...
/// show data when page is refresh
 window.addEventListener('DOMContentLoaded', async () => {
    try {
    const response=await axios.get('https://crudcrud.com/api/effefa6daf8b4267921b918351ecf91c/userDeatils')
